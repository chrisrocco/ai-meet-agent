...
- [ ] **Phase 1: Virtual Device Setup** - Virtual camera and microphone appear in browser device selector on both native Linux and WSL2
- [ ] **Phase 2: Audio Pipeline** - Audio captured from Meet participants and playable through virtual mic with echo-free topology
...
- [ ] 01-02-PLAN.md — Native Linux device layer: prerequisites, VirtualCamera, VirtualAudioDevices, DeviceManager
